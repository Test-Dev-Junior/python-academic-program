...
def actualizarEstudiante(f_body):
    ...
    btn_update=Button(f_form,image=img_update,width=200,pady=7,text="Actualizar Estudiante",bg="white",fg="black",border=0,font=(vg.g_font,10),compound=LEFT,command=actualizarEstudiante)
